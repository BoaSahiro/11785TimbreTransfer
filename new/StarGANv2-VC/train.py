...
@click.command()
@click.option('-p', '--config_path', default='/root/timbre/timbre_transfer/new/StarGANv2-VC/Configs/config.yml', type=str)
...
def main(config_path):
    ...
    for _ in range(1, epochs+1):
        ...
        if (epoch % save_freq) == 0:
            trainer.save_checkpoint(osp.join(log_dir, 'checkpoint.pth'))
