...
if __name__ == '__main__':
    ...
    parser.add_argument('--spectrogram_path', type=str, default='/root/timbre/piano_test_short.npy')
    parser.add_argument('--emb_org', type=str, default='/root/timbre/data_syn/entries/piano_entry_embeddings.npy')
    parser.add_argument('--emb_trg', type=str, default='/root/timbre/data_syn/entries/piano_entry_embeddings.npy')
